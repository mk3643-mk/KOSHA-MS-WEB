...
const startMarker = '{/* 2.5 Revision History Section (Versioning) */}';
const endMarker = '{/* 3. Related Documents List (하단) */}';
...
const newComponent = `        {/* 2.5 Revision History Section (Versioning) */}
                                                    {selectedStandard && (
